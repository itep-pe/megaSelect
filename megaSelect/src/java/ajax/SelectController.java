...
public class SelectController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < listaCarros.size(); i++) {
            stringBuilder.append(listaCarros.get(i).getCodAtividade()
                    + "-" + listaCarros.get(i).getModelo()
                    + "-" + listaCarros.get(i).getPlaca() + "/");
        }
    ...
    private List<Veiculo> consultaCarrosAtividade(String codigoAtividade) {
        ...
        listaCarros.add(new Veiculo("GOL", "GVW 5510", "A1"));
        listaCarros.add(new Veiculo("UNO", "EQP 0002", "A2"));
        listaCarros.add(new Veiculo("FIESTA", "BRA 2002", "A3"));
        listaCarros.add(new Veiculo("HILLUX", "GON 6606", "A1"));
        listaCarros.add(new Veiculo("FREEMONT", "GAH 2640", "A2"));
        listaCarros.add(new Veiculo("S10", "CSC 2013", "A3"));
        listaCarros.add(new Veiculo("TUCSON", "BRA 2014", "A1"));
        listaCarros.add(new Veiculo("AMAROK", "NQC 0876", "A2"));
        listaCarros.add(new Veiculo("SAVEIRO", "PLM 5748", "A3"));
